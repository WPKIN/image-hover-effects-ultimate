                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo esc_url(admin_url("admin.php?page=oxi-image-hover-ultimate&effects=$effects&styleid=$id")) ?>"
                                           title="Edit" class="btn btn-primary" style="float:left; margin-right: 5px;">Edit</a>
                                        <a href="#" title="Clone" class="btn btn-secondary oxi-addons-style-clone"
                                           datavalue="<?php echo (int)$id; ?>" style="float:left; margin-right: 5px;">Clone</a>
                                        <a href="<?php echo esc_url(rest_url() . 'ImageHoverUltimate/v1/shortcode_export?styleid=' . $id . '& _wpnonce=' . wp_create_nonce('wp_rest')); ?>"
                                           title="Export" class="btn btn-info" style="float:left; margin-right: 5px;">Export</a>
