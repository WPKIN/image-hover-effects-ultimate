    ...
    public function render() {
        ...
        <div id="get-pro" class="getting-started-content content-get-pro active">
            <div class="content-heading">
                ...
                <a href="https://oxilab.dev/image-hover-effects/pricing/" class="oxilab-btn btn-primary get-pro-btn" target="_blank" rel="noopener noreferrer">
            ...
            <div class="get-pro-cta">
                ...
                <div class="cta-btn">
                    <a href="https://oxilab.dev/image-hover-effects/pricing/" class="oxilab-btn btn-primary" target="_blank" rel="noopener noreferrer">
